...
export async function generateMetadata({ params }) {
  ...
  return { title: idea?.title, description: idea.shortDescription };
}
        ...
        <div className="bg-white dark:bg-zinc-900 border border-black/[0.08] dark:border-white/[0.08] sm:rounded-2xl px-5 py-4 sm:mb-5">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
            <div className="flex-1 min-w-0">
              ...
              <h1 className="text-[20px] sm:text-[24px] font-bold text-black dark:text-white tracking-[-0.03em] leading-tight">
                {idea.title}
              </h1>
              <p className="text-[13px] font-normal text-black/50 dark:text-white/50 tracking-[-0.1px] mt-1.5 leading-relaxed">
            ...
            <div className="bg-white dark:bg-zinc-900 border border-black/[0.08] dark:border-white/[0.08] sm:rounded-2xl p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[12px] font-normal text-black/50 dark:text-white/50 tracking-[-0.1px]">
                    {idea.author.email}
                  </p>
                  <p className="text-[11px] font-normal text-black/40 dark:text-white/40 tracking-[-0.1px]">
                    Posted{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-4">
              <div className="bg-white dark:bg-zinc-900 border border-black/[0.08] dark:border-white/[0.08] sm:rounded-2xl p-5">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 className="text-[14px] font-bold text-black dark:text-white tracking-[-0.02em]">
                    Problem
                  </h2>
                </div>
                <p className="text-[13px] font-normal text-black dark:text-white leading-relaxed tracking-[-0.1px]">
          ...
          <div className="w-full lg:w-[280px] shrink-0 flex flex-col sm:gap-3.5 lg:sticky lg:top-[72px] ">
            ...
            <div className="bg-white dark:bg-zinc-900 border border-black/[0.08] dark:border-white/[0.08] sm:rounded-2xl p-5">
              ...
              <div className="flex flex-col gap-2.5">
                <div className="flex items-center justify-between">
                  <span className="text-[13px] font-normal text-black dark:text-white tracking-[-0.1px]">
                    Likes
                  </span>
            ...
            <div className="bg-white dark:bg-zinc-900 border border-black/[0.08] dark:border-white/[0.08] sm:rounded-2xl p-5">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-start gap-2.5">
                  <HiUsers className="text-[15px] text-black dark:text-white shrink-0 mt-0.5" />
                  <div>
                    <p className="text-[11px] font-normal text-black/40 dark:text-white/40 tracking-[-0.1px]">
                      Target Audience
                    </p>
                    <p className="text-[13px] font-normal text-black dark:text-white tracking-[-0.1px]">
                      {idea.targetAudience}
                    </p>
                  </div>
                </div>
                <div className="h-px bg-black/[0.06] dark:bg-white/[0.06]" />
                <div className="flex items-start gap-2.5">
                  <HiCurrencyDollar className="text-[15px] text-black dark:text-white shrink-0 mt-0.5" />
                  <div>
                    <p className="text-[11px] font-normal text-black/40 dark:text-white/40 tracking-[-0.1px]">
                      Estimated Budget
                    </p>
                ...
                <div className="h-px bg-black/[0.06] dark:bg-white/[0.06]" />
                <div className="flex items-start gap-2.5">
                  <HiCalendar className="text-[15px] text-black dark:text-white shrink-0 mt-0.5" />
                  <div>
                    <p className="text-[11px] font-normal text-black/40 dark:text-white/40 tracking-[-0.1px]">
                      Posted
                    </p>
            ...
            <div className="bg-white dark:bg-zinc-900 border border-black/[0.08] dark:border-white/[0.08] sm:rounded-2xl p-5">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="flex items-center gap-1">
                    <p className="text-[13px] font-bold text-black dark:text-white tracking-[-0.1px]">
                      {idea.author.name}
                    </p>
                    <HiBadgeCheck className="text-blue-500 text-[13px]" />
                  </div>
                  <p className="text-[11px] font-normal text-black/50 dark:text-white/50 tracking-[-0.1px]">
                    {idea.author.email}
                  </p>
                </div>
              </div>
