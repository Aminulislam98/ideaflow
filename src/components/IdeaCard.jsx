  ...
  return (
    <div className="flex flex-col bg-white border border-black/[0.06] rounded-none sm:rounded-2xl overflow-hidden transition-all duration-200 hover:border-black/20">
      ...
      <div className="flex items-center justify-between px-4 pt-4 pb-3">
        ...
        <span className="text-[11px] font-medium tracking-[-0.1px] px-2.5 py-1 rounded-full bg-black/[0.04] text-black/50">
          {idea.category}
        </span>
      </div>
      ...
      <div className="px-4 pb-3">
        <h3 className="text-[14px] font-semibold text-black tracking-[-0.02em] leading-snug mb-1 line-clamp-1">
          {idea.title}
        </h3>
        <p className="text-[12.5px] font-normal text-black/50 tracking-[-0.1px] leading-relaxed line-clamp-1">
          {idea.shortDescription}{" "}
          <Link
            href={`/ideas/${idea._id}`}
            className="text-black/70 font-medium hover:underline"
          >
            See more
          </Link>
        </p>
      ...
      <div className="flex items-center px-2 py-1 gap-1">
        {/* Like */}
        <button className="flex-1 flex items-center justify-center gap-1.5 text-black/50 hover:text-blue-500 hover:bg-blue-50 py-2.5 rounded-xl transition-all duration-150">
        ...
        >
          ...
          <span className="text-[13px] text-black/40">{idea.commentCount}</span>
        </button>

        {/* View Details */}
        <Link
          href={`/ideas/${idea._id}`}
          className="flex-1 flex items-center justify-center gap-1.5 text-black/50 hover:text-black hover:bg-black/[0.04] py-2.5 rounded-xl transition-all duration-150"
        >
              ...
              <div className="flex-1 overflow-y-auto overscroll-contain [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                ...
                <div className="flex items-center gap-2.5 px-3 pt-3 pb-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1">
                      <p className="text-[14px] font-bold text-black tracking-[-0.1px] leading-none">
                        {idea.author?.name}
                      </p>
                      <HiBadgeCheck className="text-blue-500 text-[14px] shrink-0" />
                    </div>
                  ...
                  <span className="text-[11px] font-medium px-2.5 py-1 rounded-full bg-black/[0.04] text-black/50 shrink-0">
                    {idea.category}
                  </span>
                </div>
                ...
                <div className="px-3 pb-2">
                  <h3 className="text-[14px] font-bold text-black tracking-[-0.02em] leading-snug mb-1">
                    {idea.title}
                  </h3>
                  <p className="text-[13px] font-normal text-black/50 leading-relaxed">
                    {idea.shortDescription}
                  </p>
                </div>
                ...
                {/* Like + Comment count */}
                <div className="flex items-center gap-4 px-3 py-2.5 border-b border-black/[0.06]">
                  <span className="flex items-center gap-1.5 text-[13px] font-normal text-black/50">
                            ...
                            {c.isOwn && (
                              <div className="relative shrink-0">
                                <button
                                  ...
                                  className="w-6 h-6 flex items-center justify-center rounded-full hover:bg-black/[0.08] text-black/30 hover:text-black transition-all duration-150"
                                >
                                  <HiDotsHorizontal className="text-[14px]" />
                                </button>
                                {openMenuId === c._id && (
                                  <div className="absolute right-0 top-full mt-1 w-[130px] bg-white border border-black/[0.08] rounded-xl overflow-hidden shadow-[0_4px_20px_rgb(0,0,0,0.1)] z-20">
                                    <button className="w-full flex items-center gap-2 px-3 py-2.5 text-[13px] font-normal text-black hover:bg-black/[0.04] transition-all duration-150">
                                      <HiPencil className="text-[13px]" />
                                      Edit
                                    </button>
                                    <button className="w-full flex items-center gap-2 px-3 py-2.5 text-[13px] font-normal text-red-500 hover:bg-red-50 transition-all duration-150">
              ...
              <div className="border-t border-black/[0.06] py-2.5 bg-white flex items-center gap-2 shrink-0 px-3">
                ...
                <div className="flex-1 flex items-center gap-2 bg-[#f0f2f5] rounded-full px-3 py-2">
                  <input
                    ...
                    className="flex-1 bg-transparent text-[13px] font-normal text-black placeholder:text-black/30 outline-none min-w-0"
                  />
                  <button
                    disabled={!comment.trim()}
                    className="text-blue-500 disabled:text-black/20 transition-colors duration-150 shrink-0 rotate-90"
                  >
